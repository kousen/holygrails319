...
<html>
    ...
    <body>
        ...
        <div id="show-knight" class="content scaffold-show" role="main">
            ...
            <f:display bean="knight" />
            <g:form resource="${this.knight}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.knight}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
