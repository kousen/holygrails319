...
<html>
    ...
    <body>
        ...
        <div id="edit-quest" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.quest}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.quest}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.quest}" method="PUT">
                <g:hiddenField name="version" value="${this.quest?.version}" />
                <fieldset class="form">
                    <f:all bean="quest"/>
                </fieldset>
