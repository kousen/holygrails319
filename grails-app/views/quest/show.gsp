...
<html>
    ...
    <body>
        ...
        <div id="show-quest" class="content scaffold-show" role="main">
            ...
            <f:display bean="quest" />
            <g:form resource="${this.quest}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.quest}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
