...
<html>
    ...
    <body>
        ...
        <div id="show-castle" class="content scaffold-show" role="main">
            ...
            <f:display bean="castle" />
            <g:form resource="${this.castle}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.castle}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
